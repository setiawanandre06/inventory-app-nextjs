...
export default function LoginPage() {
    ...
    return (
        <main
            ...
            style={{
                backgroundImage: "linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('/images/login_bg.jpg')",
            ...
            <div className="py-4 max-w-md w-full">
                <div
                    ...
                    <div className="mb-6 flex justify-center">
                        <a href="#"><img src="https://readymadeui.com/logo-alt.svg" alt="logo" className="w-12 min-h-12" />
                        </a>
                    </div>
